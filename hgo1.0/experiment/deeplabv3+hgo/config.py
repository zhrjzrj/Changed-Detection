...
class Configuration():
	def __init__(self):
		...
		self.EXP_NAME = 'deeplabv3+hgo'

		self.DATA_NAME = 'hgo2019'
		self.DATA_AUG = True
		self.DATA_WORKERS = 8
		...
		self.TEST_FLIP = True
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'model/deeplabv3+hgo/deeplabv3plus_res101_atrous_hgo2019_itr780.pth')
		self.TEST_GPUS = 4
		self.TEST_BATCHES = 6		
